...
if (!isset($_SESSION['successpageb'])) {
...
<body>
    <section class="appoint-main-sect">
        ...
        <div class="main-cont-app">
            <div class="form-cont-pethealth">
                <div class="main-logo"> <a href="http://">Pentagonia</a>
                <div class="logoutbin">
                
                <?php if (isset($_SESSION['username'])) : ?>
                    <p><a href="index.php?logout='1'" class="logoutB"> Cancel </a></p>
                <?php endif ?>
            </div>
                ...
                <div class="mini-form">
                    ...
                    <form method="POST" action="server.php">
                        ...
                        <div class="pethealth-inner">
                            <select class="num" name="ownercode" id="" required>
                                ...
                                <optgroup label="Other countries">
                                    ...
                                    <option data-countryCode="MQ" value="v596">Martinique (+596)</option>
                                    ...
                                    <option data-countryCode="PH" value="+63" Selected>PH(+63) </option>
                        ...
                        <div class="owner-inner">
                            <label>Date of <br>Appointment</label>
                            <input type="Date" name="Date" id="" placeholder="Date of Appointment" required>
                            <select name="scheduletime">
                                <option value="" selected>-time-</option>
                                <option value="08 AM">08:00 AM</option>
